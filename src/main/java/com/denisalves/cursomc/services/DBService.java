...
import com.denisalves.cursomc.domain.Estado;
...
import com.denisalves.cursomc.domain.PagamentoComCartao;
...
import com.denisalves.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcos.denisjr@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "dee.alves2@gmail.com", "05240832072", TipoCliente.PESSOAFISICA, pe.encode("123"));
